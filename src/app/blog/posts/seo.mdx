---
title: "SEO settings for Thakur's Portfolio"
summary: "Manage your Thakur's Portfolio's SEO settings."
...
Thakur's Portfolio automatically generates meta- and open graph tags for your pages based on the `content.js` file.

## Schema

Thakur's Portfolio automatically generates schema tags for your pages based on the `content.js` file.
