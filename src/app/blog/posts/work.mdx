...
summary: "Create, edit and delete projects in the work section of your Thakur's Portfolio."
...
summary: "My Project is a design system that empowers indie creators, small teams, and startups to build web applications."
images:
...
link: "https://www.thakurdipak.com.np/work"
---`,
        language: "tsx",
...
You can use MDX to write the content of your projects. It helps you write rich and dynamic content with minimal code. Some MDX elements will be automatically transformed to My Project components to integrate better in the design and add additional functionality.
