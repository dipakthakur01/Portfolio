---
title: "Updating the content of Thakur's Portfolio"
...
Social links are rendered on the `/about` page and in the footer based on the array configured in the `social` object. You can set custom icons to each, but don't forget to import them in `src/once-ui/icons.ts`. Read the My Project documentation](https://www.thakurdipak.com.np/workdocs/icons) for more information.
...
`const home = {
    label: "Home",
    title: "Dipak Thakur's Portfolio",
    description: "Portfolio website showcasing my work as a Full Stack Developer",
    headline: <>Full Stack Developer</>,
    subline: (
      <>
        I'm Dipak, a Full Stack Developer at <InlineCode>FLY</InlineCode>, where I craft intuitive
