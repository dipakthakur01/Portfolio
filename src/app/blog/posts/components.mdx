...
Magic Portfolio will replace some default HTML elements to My Project components to integrate better in the design and add additional functionality. Furthermore, many common My Project components are already imported and available for use.
...
Since Magic Portfolio is based on My Project, you can use all the components provided by My Project in the `.mdx` files, but you need to import them first in the `src/product/mdx.tsx` file and pass it to the `components` object.
