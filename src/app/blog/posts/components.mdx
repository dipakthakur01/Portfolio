...
Thakur's Portfolio will replace some default HTML elements to My Project components to integrate better in the design and add additional functionality. Furthermore, many common My Project components are already imported and available for use.
...
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/work" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/table" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
The code block component works based on My Project's CodeBlock. You can access it with the complete syntax for full customization, or by using the standard markdown syntax (triple backticks) with pre-configured props.
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/codeBlock" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>

### InlineCode

The `InlineCode` is another My Project component that you can access either through the complete syntax or the short syntax (backticks). Usually the standard markdown syntax is recommended, since it doesn't have that much configuration options.
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/inlineCode" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/accordion" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/button" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/card" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>

## Icon

Icons are used to visually represent actions, objects, or concepts. For instructions on importing new icons, head over to [the My Project documentation](https://www.thakurdipak.com.np/workdocs/icons).
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/icon" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/flex" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/grid" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/Media" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://www.thakurdipak.com.np/workdocs/smart-link" weight="default" label="View on My Project" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>

## Custom components

Since Thakur's Portfolio is based on My Project, you can use all the components provided by My Project in the `.mdx` files, but you need to import them first in the `src/product/mdx.tsx` file and pass it to the `components` object.
